...
## Project Structure
    ...
    ├── tst_daniel_retry_op_22983  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_retry_op_22983`
...
2. Clone this repo and `cd tst_daniel_retry_op_22983`
